...
| **Product experimentation practice** | Product experimentation discipline maps directly onto benchmark design and claim validation. |
...
- Sibling repo: `counter` — counterfactual reasoning for agents.
