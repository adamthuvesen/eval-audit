"""Exhibit C harness — `eval-audit/exhibit-c-direct-v1`.

Calls the Anthropic Messages API once per (model, task, run) and writes the
raw response to ``scouting/exhibit-c/raw/<agent_short>/<task_id>/<run_id>.json``.
...
Usage:
    ...
    uv run python scouting/exhibit-c/run.py
...
MODELS = [
    {
        "agent_id": "exhibit-c-haiku-4-5",
        "agent_short": "haiku45",
        "model_id": "claude-haiku-4-5-20251001",
    },
    {
        "agent_id": "exhibit-c-sonnet-4-6",
