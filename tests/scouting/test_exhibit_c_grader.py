"""Acceptance tests for the Exhibit C grader's subprocess sandbox.
...
GRADE_PATH = REPO_ROOT / "scouting" / "exhibit-c" / "grade.py"


def _load_grade_module():
    spec = importlib.util.spec_from_file_location("exhibit_c_grade", GRADE_PATH)
